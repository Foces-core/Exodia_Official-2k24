function RegisterSection()
{
    return (
        ...
        <div className="flex justify-center my-10">
            {/* Card Main Container */}
            <div className="relative w-2/3 h-[35vh] ">
                {/* Content */}
                <div className=" bg-[#151515] w-full h-[35vh] flex flex-col justify-center items-center border-[#1D9D51] border-[2px] rounded-xl z-10 ">
                    <p className="text-[#1D9D51] text-4xl font-bold max-sm:text-2xl">What are you waiting for ?</p>
                    <p className="text-[#1D9D51] font-light text-2xl italic max-sm:text-xl">Time is ticking, opportunities missing </p>
