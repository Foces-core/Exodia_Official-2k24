    ...
    <div className="h-screen w-full flex items-center justify-center">
      ...
      <div className="flex justify-center my-10 w-full">
        ...
        <div className="relative w-2/3 h-[35vh] max-[390px]:w-5/6">
          {/* Content */}
          <div className="bg-[#151515] px-4 w-full h-[35vh] flex flex-col justify-center items-center border-[#1D9D51] border-[2px] rounded-xl z-10">
            ...
            <a className="p-2 my-10 text-lg font-bold bg-white px-14 rounded-2xl">Register</a>
          </div>
