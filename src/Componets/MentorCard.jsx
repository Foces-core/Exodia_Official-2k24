...
function MentorCard( props)
{
    return(
        <>
        <div className={"relative flex items-center -z-10 w-[41vw] h-[25vh] max-[768px]:justify-normal max-[768px]:w-fit max-[550px]:h-[20vh] max-[428px]:w-full border border-[#9329FE] rounded-[17px] bg-black "+((props.Index%2==0)?"justify-normal":"justify-end")} >
            {/* Image Section */}
            ...
            {/* Middle Section */}
            <div className="hidden max-[768px]:flex w-[28vh] h-[28vh] max-[550px]:w-[20vh] max-[428px]:w-[22.5vh]">
            ...
            {/* Topic Section */}
            <div className={"absolute bg-[#1D9D51] h-[5vh] px-8 rounded-full  bottom-6 flex justify-center max-[768px]:-bottom-5  max-[768px]:left-6 items-center max-[428px]:left-3 "+((props.Index%2==0)?"min-[769px]:-right-12":"-left-12")}>
