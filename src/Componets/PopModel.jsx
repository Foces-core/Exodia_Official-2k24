                 ...
                 {/* ////////////////////// */}
                    ...
                    {/* ///////////////////// BOX ///////////////////*/}
                      <div className="relative flex flex-col mt-2 w-full items-center h-96 bg-zinc-900">
                        <p className="col text-4xl theme text-white pt-4">GENERATIVE AI</p>
                      ...
                      {/* ////////////inner div////////////// */}
                      <div className='col h-3/4 w-2/3 rounded-lg mt-6 p-5 bg-neutral-950 text-white max-sm:text-xs'>
                      <div className='flex  py-2 px-4'><img src={forward} alt="" /><p className='ml-4'>hdsakflllljhgjsjd</p></div>
                      <div className='flex  py-2 px-4'><img src={forward} alt="" /><p className='ml-4'>hdsakflllljhgjsjdfgsfgagfagfda</p></div>
                      <div className='flex  py-2 px-4'><img src={forward} alt="" /><p className='ml-4'>hdsakflllljhgjsjdfdgadgafgagdsgsd</p></div>
                      <div className='flex  py-2 px-4'><img src={forward} alt="" /><p className='ml-4'>hdsakflllljhgjsjdafdgadfbaa</p></div>
                      <div className='flex  py-2 px-4'><img src={forward} alt="" /><p className='ml-4'>hdsakflllljhgjsjdafdgadgfdgfdgfd</p></div>
