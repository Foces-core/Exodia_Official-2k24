    ...
    return(
        ...
        <div className="relative flex  justify-center max-[768px]:items-center h-fit my-14 max-[768px]:flex-col-reverse" id='Mentors'>
            ...
            <div className="relative w-14 max-[768px]:w-fit max-[768px]:h-fit max-[768px]:py-10">    
                <p className="absolute text-white rotate-90 text-8xl theme h-fit w-fit top-[50%] max-[550px]:text-5xl -right-[30vh] max-[768px]:rotate-0  max-[768px]:relative max-[768px]:right-0 max-[768px]:top-0 ">MENTORS</p>
            </div>
            {/* Mentors Background */}
            <img src={MentorImg} alt="" className="absolute bottom-0 w-full  z-10"/>
        </div>
