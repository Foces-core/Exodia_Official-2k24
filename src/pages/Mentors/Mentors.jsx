...
function Mentors() {
    return(
        <>
        {/* Screen Conatiner */}
        <div className="relative flex w-screen justify-center max-[768px]:items-center h-fit my-14 max-[768px]:flex-col-reverse">
            {/* Cards Container */}
            <div className="flex flex-col items-center gap-20 px-[15vh] max-[768px]:w-full max-[768px]:px-12 max-[768px]:gap-32 my-10">
            ...
            {/* Heading */}
            <div className="relative w-14 max-[768px]:w-fit max-[768px]:h-fit max-[768px]:p-10">    
                <p className="absolute text-white rotate-90 text-8xl theme h-fit w-fit top-[50%] -right-[30vh] max-[768px]:rotate-0 max-[768px]:relative max-[768px]:right-0 max-[768px]:top-0">MENTORS</p>
            </div>
            {/* Mentors Background */}
