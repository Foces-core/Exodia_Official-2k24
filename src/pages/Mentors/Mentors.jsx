    ...
    return(
        ...
        <div className="relative flex  justify-center max-[768px]:items-center h-fit my-14 max-[768px]:flex-col-reverse" id='Mentors'>
            ...
            <div className="flex flex-col items-center gap-20 px-[15vh] max-[428px]:px-6 max-[375px]:px-2 max-[768px]:w-full max-[768px]:px-12 max-[768px]:gap-32 my-10">
                ...
                <MentorCard Name="AROMAL S" Desc="SDE @IBM ISL [Data & AI ~ IBM watsonx] " Topic="Generative AI" Image={AromalImg} Index={1} link="https://www.linkedin.com/in/aromalsanthosh?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"/>
            ...
            {/* Mentors Background */}
            <img src={MentorImg} alt="background-image" className="absolute bottom-1 z-0 w-full max-md:bottom-96"/>
        </div>
