    ...
    <>
      <div id='About' className="flex flex-col items-center justify-center gap-10">
        <div className="flex flex-col gap-5 p-5 w-fit h-fit">
          ...
          <div className="w-[70vw] max-[768px]:w-[85vw] max-md:text-lg max-[375px]:w-[80vw] max-[390px]:text-sm min-h-72 text-justify text-2xl t p-5 max-[470px]:p-5 border border-t-3 rounded-tr-xl rounded-bl-xl border-[#9329FE] text-gray-200 border-gradient">
            <p>
