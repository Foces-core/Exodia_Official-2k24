...
{
    return (
        <div className="relative flex flex-col items-center justify-center w-full gap-10 p-10 py-18" id="Contact">
            <p className="theme text-[#9329FE] text-3xl">Contact Us</p>
            <div className="flex w-[60vw]  h-[300px]  max-[860px]:w-[80vw] max-[1360px]:h-[250px] max-[700px]:flex-col max-[700px]:h-fit">
                ...
                <div className="w-[33%] h-full flex flex-col p-6 gap-3 justify-end bg-[#1D9D51] text-white relative overflow-hidden max-[700px]:w-full max-[700px]:h-[50%]"> 
                    ...
                    <p className="text-xl text-white theme">exoDia</p>
