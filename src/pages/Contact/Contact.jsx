...
{
    return (
        <div className="relative flex flex-col items-center justify-center w-full h-screen gap-10 p-10 py-18" id="Contact">
            ...
            <div className=" mt-20 flex w-[60vw]  h-[300px]  max-[860px]:w-[80vw] max-[1360px]:h-[250px] max-[700px]:flex-col max-[700px]:h-fit">
                ...
                <div className="w-[33%] h-full bg-black flex flex-col p-6 justify-end text-white relative overflow-hidden max-[700px]:w-full max-[700px]:h-[50%] "> 
                    ...
                    <p className="flex items-center gap-2 md:text-sm max-sm:text-xs"><AiOutlinePhone/>+91-9744184806,+91-9447351280</p>
                    <p className="flex items-center gap-2 md:text-sm max-sm:text-xs"><AiOutlinePhone/>+91-7034721200,+91-9526055034</p>
                    <p className="flex items-center gap-2 md:text-sm max-sm:text-xs"><CiMail/>exodiacec@gmail.com</p>
